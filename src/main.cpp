      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          for ( int i = 0; i < sensor_fusion.size(); i++ ) {
            ...
            // Check for other car lane
            float d = sensor_fusion[i][6];
            int car_lane = -1;
            
            // Find out which lane the other car is in
            if ( d > 0 && d < 4 ) {
              car_lane = 0;
            } else if ( d > 4 && d < 8 ) {
              car_lane = 1;
            ...
            // check other cars s after executing previous trajectory
          ...
          if(too_close_ahead)
          {
            ...
            // a car is ahead of us and quite close, slow down slowly until we match that cars speed
          ...
          if(prev_size < 2)
          {
            // add the current points to the vector
          ...
          {
            //Two points already exist, use them
          ...
          // Setting up target points in the future - 30m, 60m and 90m ahead
          ...
          // Change coordinates to local car coordinates.
          ...
          // Calculate distance y position for 30m ahead.
          ...
          for( int i = 1; i < 50 - prev_size; i++ ) {
            ...
            // Divide by 2.24 for it to be in meters per second
